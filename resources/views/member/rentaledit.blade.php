	...
	<div class="container">
		<div class="col-md-12">
			<div class="panel panel-primary">
              ...
              <form class="form-horizontal form-label-left" action="{{ route('karyawan.update',$rental->id) }}" method="post" enctype="multipart/form-data">
			  ...
			  <div class="form-group {{ $errors->has('nik_kons') ? ' has-error' : '' }}">
			  		...
			  		<div class="form-group {{ $errors->has('tgl_kembali') ? ' has-error' : '' }}">
			  			...
			  			@if ($errors->has('tgl_kembali'))
                            <span class="help-block">
                                <strong>{{ $errors->first('tgl_rerkembali') }}</strong>
                            </span>
                        @endif
			  		</div>
